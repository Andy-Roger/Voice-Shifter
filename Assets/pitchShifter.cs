...
public class pitchShifter: MonoBehaviour
{
    ...
    public static int MAX_FRAME_LENGTH = 16000;
    public static float[] gInFIFO = new float[MAX_FRAME_LENGTH];
    public static float[] gOutFIFO = new float[MAX_FRAME_LENGTH];
    public static float[] gFFTworksp = new float[2 * MAX_FRAME_LENGTH];
    public static float[] gLastPhase = new float[MAX_FRAME_LENGTH / 2 + 1];
    public static float[] gSumPhase = new float[MAX_FRAME_LENGTH / 2 + 1];
    public static float[] gOutputAccum = new float[2 * MAX_FRAME_LENGTH];
    public static float[] gAnaFreq = new float[MAX_FRAME_LENGTH];
    public static float[] gAnaMagn = new float[MAX_FRAME_LENGTH];
    public static float[] gSynFreq = new float[MAX_FRAME_LENGTH];
    public static float[] gSynMagn = new float[MAX_FRAME_LENGTH];
    public static long gRover, gInit;

    public static float[] outdata;
    ...
    public static void PitchShift(float pitchShift, long numSampsToProcess, long fftFrameSize, long osamp, float sampleRate, float[] indata)
    {
